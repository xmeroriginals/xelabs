...
(function(Scratch) {
    ...
    class Birthday {
        ...
        getNextBirthday() {
            ...
            let nextBirthday = new Date(currentYear, this.birthday.getMonth(), this.birthday.getDate());
        ...
        draw() {
            ...
            this.confettiParticles = this.confettiParticles.filter(p => p.y < this.canvas.height && p.x > 0 && p.x < this.canvas.width);
